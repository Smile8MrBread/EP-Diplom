...
<div class="container py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= Url::to(['/admin/orders']) ?>">Заказы</a></li>
        ...
        <div class="col-md-4">
            ...
            <div class="card p-4 mb-3">
                ...
                <dl class="small mb-0">
                    ...
                    <dt class="text-muted">Email аккаунта</dt><dd><?= Html::encode($order->user->email) ?></dd>
                    <?php endif ?>
                    <dt class="text-muted">Контактный email</dt><dd><?= Html::encode($order->contact_email) ?></dd>
            ...
            <a href="<?= Url::to(['/admin/orders']) ?>" class="btn btn-outline-secondary btn-sm w-100">← К заказам</a>
        </div>
    </div>
</div>
